...
class Logger(object): # what is this?
    def __init__(self):
...
save_dir = os.path.join("/home/zahra/Synthetic_Landscapes/Data", '3c_MLDE_lite', exp_name)
...
if isinstance(library, str): # when would library be str? (would it be name of zs score?)
    dclibrary = True
else:
    dclibrary = False
